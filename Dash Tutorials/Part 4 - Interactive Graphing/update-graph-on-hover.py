...
def update_graph(
    xaxis_column_name, yaxis_column_name, xaxis_type,
    ...
    fig.update_traces(customdata=data[data['Indicator Name'] == yaxis_column_name]['Country Name'])
...
def create_time_series(dff, axis_type, title):
    ...
    fig.add_annotation(
        x=0, y=0.85, xanchor='left', yanchor='bottom', xref='paper',
